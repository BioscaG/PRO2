...
sessio*, piles_i_cues, etc: carpetas con los ficheros de cada sesión

zips: carpetas comprimidas con los ficheros de cada sesión (para
descargar via web, por ejemplo)

pdfs: copias de los pds de cada sesión, que normalmente se obtienen
de la web de pro2

El material de cada sesión podría haber sido actualizado poco antes de cada
sesión concreta.
